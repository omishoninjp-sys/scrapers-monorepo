...
規則：1.坂角總本舖海老煎餅 2.ゆかり可保留或譯「緣」3.自然流暢 4.含關鍵字：坂角總本舖、日本、海老煎餅、伴手禮 5.只回傳JSON"""
    try:
...
<p style="color:#666;font-size:14px">※ &lt;¥{MIN_COST_THRESHOLD} 跳過 | <b style="color:#e74c3c">翻譯保護</b> 連續失敗 {MAX_CONSECUTIVE_TRANSLATION_FAILURES} 次停止</p>
